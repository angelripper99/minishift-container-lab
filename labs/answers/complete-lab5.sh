...
export CONTENTS="
[mariadb]
image = cdk-ip:5000/mariadb
db_pass = password
db_user = user
db_name = name
[wordpress]
image = cdk-ip:5000/wordpress
db_pass = password
db_user = user
db_name = name
[general]
...
# Tag+Push
docker tag wordpress-rhel7-atomicapp cdk-ip:5000/wordpress-rhel7-atomicapp
docker push cdk-ip:5000/wordpress-rhel7-atomicapp
